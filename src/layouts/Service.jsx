...
function Service() {
  return (
    <section className="py-8 min-h-screen text-white" id="service">
  ...
  <p className="mb-5 px-6 sm:px-8 md:px-12 lg:px-20" >Interested in building a project? Let me handle it—contact me below.</p>
    <button
              type="button"
